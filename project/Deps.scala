...
object Deps {
  ...
  val jsoniterScala      = "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "2.21.3"
  val jsoniterScalaCirce = "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-circe" % "2.21.3"
