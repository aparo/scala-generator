...
object Deps {
  ...
  val scalaFmt = "org.scalameta" %% "scalafmt-core" % "3.7.1"

  val jsoniterScala      = "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "2.21.2"
  val jsoniterScalaCirce = "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-circe" % "2.21.2"
