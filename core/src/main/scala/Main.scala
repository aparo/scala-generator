...
//  }
//
//  //emitExample("C:\\Projects\\it-gov\\elasticsearch-specification\\specification\\ingest")
////  parseDirectory(Seq(), new File("C:\\Projects\\it-gov\\elasticsearch-specification\\specification\\ingest"))
//  parseFile(Seq(), new File("C:\\Projects\\it-gov\\elasticsearch-specification\\specification\\ingest\\_types\\Processors.ts"))
//}
